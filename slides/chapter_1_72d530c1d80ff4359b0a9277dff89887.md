...
$\large{g(\mu_i) = g(E[y_i]) = \beta_0 + \beta_1x_1i + ... + \beta_px_pi + \epsilon_i}$
...
---
## Constructing GLM out of 3 components
...
`@part1`
**Random Component** 
- Identify the type of response variable
- Define the distribution function of the response variable $y_i$
