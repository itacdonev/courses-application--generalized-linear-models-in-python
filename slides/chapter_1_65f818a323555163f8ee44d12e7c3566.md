...
`@part2`
$y$ - response variable, normally distributed
...
`@part1`
Interested in *how much the response variable changes **on average** for a unit increase in the explanatory variable
...
`@script`
One of the main goals of regression is to predict Y from the explanatory variables using the relationship as the following.
...
- constant variance for all $i$; $Var(y_i) = \sigma^2$ 
